...
import { SparklesIcon, SendIcon, ImageIcon, MicIcon, PlusIcon, ChatIcon, EditIcon, BulbIcon, ReplyIcon } from '../components/icons';
...
export default function AiCopilot() {
  ...
  return (
    <div className="h-[calc(100dvh-108px)] md:h-[calc(100vh-32px)] flex flex-col max-w-3xl mx-auto">
      ...
      <div className="p-3">
        <div className="flex items-end gap-1.5 bg-black/[.06] dark:bg-white/10 rounded-2xl p-2 ps-3">
          ...
          <button className="p-2 opacity-55 hover:opacity-100" aria-label="Voice"><MicIcon size={20} /></button>
